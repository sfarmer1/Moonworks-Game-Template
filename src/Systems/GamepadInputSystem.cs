...
public struct CanReceiveDirectionalInput
{
...
public class GamepadInputSystem : MoonTools.ECS.System
{
	...
	public GamepadInputSystem(World world, Inputs inputs) : base(world)
	{
		Inputs = inputs;
		PlayerFilter = FilterBuilder
			.Include<HasPlayerOwner>()
			.Build();
	...
	public override void Update(TimeSpan timeSpan)
	{
		...
		{
			var index         = Get<HasPlayerOwner>(playerEntity).Index;
	...
	private static CanReceiveDirectionalInput InputState(ControlSet controlSet, ControlSet altControlSet)
	{
		return new CanReceiveDirectionalInput {
